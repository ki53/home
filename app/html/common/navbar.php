    <nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark">
      ...
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" id="profile" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Profile</a>
          <div class="dropdown-menu" aria-labelledby="profile">
            <a class="dropdown-item" href="https://github.com/ki53">GitHub</a>
            <a class="dropdown-item" href="https://atcoder.jp/users/ki53">atcoder</a>
          </div>
        </li>
        <li class="nav-item">
      ...
      <form class="form-inline my-2 my-lg-0">
        <input class="form-control mr-sm-2" type="text" placeholder="not" aria-label="Search">
        <button class="btn btn-outline-success my-2 my-sm-0" type="submit">active</button>
      </form>
      </div>
    </nav>
